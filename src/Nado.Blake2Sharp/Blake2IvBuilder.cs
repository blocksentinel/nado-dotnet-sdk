...
{
    private static readonly Blake2BTreeConfig SequentialTreeConfig =
        new() { IntermediateHashSize = 0, LeafSize = 0, FanOut = 1, MaxHeight = 1 };

    public static ulong[] ConfigB(
    ...
    public static void ConfigBSetNode(
        ulong[] rawConfig,
        byte depth,
        ulong nodeOffset
    )
